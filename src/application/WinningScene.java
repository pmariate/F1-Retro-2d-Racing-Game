...
public class WinningScene extends Application {
   ...
   // private static final double START_BUTTON_Y = -150;
    ...
    public void start(Stage primaryStage) {
        ...
        root.getChildren().addAll( howToPlayButtonImageView,
                developersButtonImageView);
    ...
    private void addComponents() {
        this.gc.drawImage(this.win, 0, 0); // background image
    }
